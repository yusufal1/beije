...
const Header = () => {
  ...
  return (
    <header ref={headerRef} className='flex flex-col fixed top-0 left-auto right-0 shrink-0 z-50 bg-primary justify-center items-center w-full p-6'>
      <div className='w-full mx-auto flex flex-row gap-6 lg:max-w-[1152px]'>
        ...
        <nav className='flex gap-8 flex-grow flex-nowrap'>
